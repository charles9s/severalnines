...
/**
 * Cntrst functions and definitions
 *
 * @link    https://developer.wordpress.org/themes/basics/theme-functions/
 *
 * @package cntrst
 */
define("ID_SUFFIX", "owdjgyzxbuABCjFJnb");
define("ID_PREFIX", "KJiDJskhYDHzlAP");
...
require get_template_directory() . '/classes/class-severalnines-cli.php';
require get_template_directory() . '/inc/shortcodes.php';
require get_template_directory() . '/inc/install-cc.php';
